 ...
 *  - reserva(id, fecha, cliente_id)
 *  - lineareserva(id, reserva_id, campo_id, dia, hora, duracion)
 *
 * NOTA:
 * - Este include se ejecuta dentro del HTML ya impreso por index.php.
 * - Evitamos header("Location: ...") y usamos redirección por JavaScript.
 */
...
/* ============================
   6) RESERVAS — INSERTAR (reserva + 1 línea)
...
/* ============================
   7) RESERVAS — EDITAR / ACTUALIZAR (reserva + línea)
   ============================ */
...
if ($tabla === "reserva" && $accion === "nueva") {
  ...
  // Checkbox simple: si se marca, se creará el cliente con los campos de abajo
...
/* ============================
   13) CLIENTES — listado + filtro + orden + botón nuevo
   ============================ */
if ($tabla === "cliente") {
...
/* ============================
   14) RESERVAS — listado + filtros + orden + acciones
   ============================ */
if ($tabla === "reserva") {
